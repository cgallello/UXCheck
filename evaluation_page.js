$(document).ready(function () {
	chrome.runtime.sendMessage({greeting: "gimme_evaluation_info"}, function(response) {
		...
		$('body').prepend('<h1>UX Check</h1><h2 id="results_title">Evaluation Results</h2><button id="download_button">Download as Word document</button>');
...
"AAALAAsAwQIAAFArAAAAAA==";
					...
					appendText("title", "UX Check Results");
					...
					$('.annotation').each(function(){
						...
						// Heuristic
		           		...
		           		// Severity
		           			...
		           			var severity = $(this).children('.severity').html();
		           			appendText("heading", severity);
